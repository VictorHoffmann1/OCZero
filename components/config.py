...
class BaseConfig(object):
    def __init__(
        ...
        hidden_dim: int
            dim of hidden layers in the network
        reward_dim: int
            dim of reward prediction head in the dynamics network
        top_k: int
            Top K object pairs to select in the relational network
    ...
    def set_config(self, args):
        ...
        self.exp_path = os.path.join(
            args.result_dir, args.case, args.info, args.env, seed_tag, localtime
        )
